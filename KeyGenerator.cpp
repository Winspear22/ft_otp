...
/*   Updated: 2026/03/08 18:24:50 by adnen            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << BOLD_BLUE << "KeyGenerator Constructor called." << RESET << std::endl;
}

KeyGenerator::KeyGenerator(const KeyGenerator &src)
{
	std::cout << BOLD_BLUE << "KeyGenerator copy constructor called." << RESET << std::endl;
	*this = src;
}

KeyGenerator &KeyGenerator::operator=(const KeyGenerator &src)
{
	std::cout << BOLD_BLUE << "KeyGenerator operator= called." << RESET << std::endl;
	(void)src;
	return *this;
}
...
KeyGenerator::~KeyGenerator()
{
	std::cout << BOLD_BLUE << "KeyGenerator Destructor called." << RESET << std::endl;
}
